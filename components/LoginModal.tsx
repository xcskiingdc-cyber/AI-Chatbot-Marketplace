...
const LoginModal: React.FC<LoginModalProps> = ({ onClose }) => {
  ...
  const formFieldClasses = "w-full p-3 bg-[--bg-secondary] border border-[--border-color] rounded-md focus:outline-none focus:ring-2 focus:ring-[--accent-primary] text-[--text-primary]";
      ...
      <div className="bg-[--bg-primary] rounded-lg shadow-xl w-full max-w-md relative border border-[--border-color]">
        ...
        <div className="p-8">
            ...
            <div className="flex items-center my-6">
                <div className="flex-grow bg-[--border-color] h-px"></div>
                <span className="mx-4 text-[--text-secondary] text-sm">OR</span>
                <div className="flex-grow bg-[--border-color] h-px"></div>
            </div>

            <button onClick={handleGoogleLogin} className="w-full py-3 bg-[--bg-secondary] hover:bg-[--bg-hover] rounded-md transition-colors font-semibold flex items-center justify-center gap-2">
                {/* Basic Google Icon */}
